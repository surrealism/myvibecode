...
OUTPUT_FILE = OUTPUT_DIR / "航拍无人机市场分析报告.xlsx"

C = {"title_bg":"2C3E50","title_fg":"FFFFFF","header_bg":"34495E","header_fg":"FFFFFF","sub_bg":"D5DBDB","deep":"2C3E50","light_gray":"F2F2F2","white":"FFFFFF"}

thin_border = Border(left=Side(style="thin",color="ABB2B9"),right=Side(style="thin",color="ABB2B9"),top=Side(style="thin",color="ABB2B9"),bottom=Side(style="thin",color="ABB2B9"))

def _f(size=10,bold=False,color="000000"): return Font(name="微软雅黑",size=size,bold=bold,color=color)
def _fl(hex_c): return PatternFill(start_color=hex_c,end_color=hex_c,fill_type="solid")
...
# Run: python generate_drone_market_report.py

def main():
    wb = openpyxl.Workbook()
    wb.remove(wb.active)
    print("Generating drone market report...")
